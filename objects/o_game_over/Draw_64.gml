...
draw_text_color(_interface_width * 0.5, _interface_height * 0.5, "DEAD!", c_white, c_white, c_white, c_white, 1);

draw_set_text(c_white, _sub_font, fa_center, fa_middle);
draw_text_color(_interface_width * 0.5, _interface_height * 0.75, "Press any key to restart!", c_white, c_white, c_white, c_white, 1);
default_font();